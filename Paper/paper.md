...
# Appendix
In this section, we present the graphical representations of the block length selectors in `BLeS`. For details of these methods, the readers are referred to the source articles and @tabassum2026[In Review] for a comprehensive overview. 
...
![Block length selection for tapered block bootstrap (TBB), and its extended version (ETBB). (Politis, D. N. (2003). Adaptive bandwidth choice. Journal of Nonparametric Statistics, 15(4-5), 517-533.)\label{fig:tbb}](bles_tbb.pdf)
